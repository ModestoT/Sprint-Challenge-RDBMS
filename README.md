...
1. Explain the difference between `RDBMS` and `SQL`.
  ...
  RDMS or Relational DataBase Management Systems is a way to store data, more specificy store data in a tables format. SQL or Structed Query language is what you would use
  to ineract with the database and manage the data in it.
...
1. What do we need in order to have a _many to many_ relationship between two tables.
  A third table that as foreign keys for both tables
